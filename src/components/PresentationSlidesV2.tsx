...
function Footer({
  ...
  return (
    <div className={cls}>
      <span style={{ flex: 1 }}>
        Allianz&nbsp;·&nbsp;Predicción de Direct Debit con ML
      </span>
    ...
    const updateSlideLabel = (deck: RevealApi) => {
      const slides = Array.from(
        containerRef.current?.querySelectorAll<HTMLElement>(
          '.slides > section:not([data-visibility="uncounted"])',
        ) ?? [],
      );
        ...
        <div className="slides">
          ...
          <section>
            <div className="s-dark" style={{ padding: '0' }}>
              ...
              >
                ALLIANZ BENELUX&nbsp;&nbsp;·&nbsp;&nbsp;DATA &amp; ANALYTICS
                OFFICE
              </div>
              {/* Main title */}
              <div
                className="t-title-white"
                style={{
                  position: 'absolute',
                  left: '6.4%',
                  top: '30%',
              ...
              >
                Cómo identificar a los contratos con mayor potencial de adopción
                para priorizar campañas comerciales, fortalecer el flujo de
                efectivo y acortar el ciclo de conversión de caja.
              </div>
              {/* Presentado a */}
              <div
                style={{
              ...
              >
                <span className="t-body-dark">
                  <span style={{ color: 'var(--gold)', fontWeight: 700 }}>
                    Presentado a:&nbsp;&nbsp;
                  </span>
                  Junta Directiva&nbsp;·&nbsp;Chief Data &amp; Analytics Officer
                </span>
              </div>
              {/* Equipo */}
              <div
          ...
          <section>
            <div className="s-dark">
              <div
                className="t-section"
                style={{ position: 'absolute', left: '6%', top: '9.3%' }}
              >
                LA PREGUNTA DE NEGOCIO
              </div>
              <div
                className="t-slide-h2-dark"
                style={{
                  position: 'absolute',
                  left: '6%',
                  top: '15.3%',
              ...
              >
                Solo el 21% de los contratos de Allianz se pagan por Direct
                Debit,
                <br />
                frente al 65% del mercado.
              </div>
              ...
              >
                <div className="metric-num-big" style={{ color: '#F87171' }}>
                  21%
                </div>
                <div className="metric-lbl" style={{ color: 'var(--muted)' }}>
                  Adopción actual de
                  <br />
                  Direct Debit en Allianz
                </div>
              </div>
              {/* Metric 2: 65% */}
              <div
              ...
              >
                ...
                <div className="t-body-dark">
                  Allianz quiere una forma inteligente de identificar a los
                  contratos más prometedores y concentrar el esfuerzo comercial
                  donde la probabilidad de conversión es alta.
                </div>
              </div>
          ...
          <section>
            <div className="s-light">
              ...
              {[
                {
                  icon: '💰',
                  title: 'Flujo de efectivo confiable',
                  body: 'Allianz sabe con precisión cuándo y cuánto entra, mejorando el forecast y la planeación financiera.',
                  left: '4.5%',
                },
                {
                  icon: '⏱️',
                  title: 'Ciclo de caja más corto',
                  body: 'Acorta el período de cobro de cuentas por cobrar y reduce el tiempo que el efectivo queda inmovilizado (CCC).',
                  left: '27%',
                },
                {
                  icon: '📉',
                  title: 'Menor costo operativo',
                  body: 'Reduce el esfuerzo manual de facturación y cobranza, simplificando el proceso administrativo.',
                  left: '49.5%',
                },
                {
                  icon: '🔒',
                  title: 'Mayor retención',
                  body: 'Los pagos continúan salvo solicitud explícita del cliente, lo que disminuye la tasa de cancelación (churn).',
                  left: '72%',
                },
              ].map((v) => (
                <div
                ...
                >
                  <div style={{ fontSize: '1.6rem', marginBottom: '.4rem' }}>
                    {v.icon}
                  </div>
                  <div
                    style={{
                  ...
                  <div className="t-body-light" style={{ fontSize: '.78rem' }}>
                    {v.body}
                  </div>
                </div>
              ))}
              ...
              >
                <span style={{ fontWeight: 700, color: 'var(--dark)' }}>
                  Marco estratégico (CRISP-DM).&nbsp;&nbsp;
                </span>
                <span className="t-body-light">
                  El modelo predictivo es la fase de modelado de un proyecto que
                  termina en una estrategia accionable: una lista priorizada de
                  contratos para que Marketing y Comercial actúen con foco, no a
                  ciegas.
                </span>
              </div>
            ...
            <div className="s-light">
              ...
              {[
                {
                  num: 1,
                  title: 'Limpieza',
                  body: 'Duplicados eliminados, target validado (0/1), tipos numéricos corregidos. Se conserva «No age» = empresas.',
                  left: '4.5%',
                },
                {
                  num: 2,
                  title: 'Anti-fuga',
                  body: 'Se eliminan IDs de cliente, contrato y broker para que el modelo aprenda patrones, no memorice registros.',
                  left: '22.5%',
                },
                {
                  num: 3,
                  title: 'Feature engineering',
                  body: 'Variables con lógica de negocio: frecuencia de pago, pagos por año, log de prima y conteos de relación.',
                  left: '40.5%',
                },
                {
                  num: 4,
                  title: 'Encoding',
                  body: 'Imputación y escalado de numéricas; One-Hot Encoding de categóricas para el entrenamiento.',
                  left: '58.5%',
                },
                {
                  num: 5,
                  title: 'Modelado',
                  body: 'Baselines + Regresión Logística vs. Random Forest y XGBoost, evaluados sobre el mismo conjunto de prueba.',
                  left: '76.5%',
                },
              ].map((step) => (
                <div
                ...
                >
                  <div
                    className="step-num step-num-gold"
                  ...
                  <div className="t-body-light" style={{ fontSize: '.75rem' }}>
                    {step.body}
                  </div>
                </div>
              ))}
              ...
              >
                ...
                <span className="t-body-light" style={{ fontSize: '.78rem' }}>
                  Monthly_mandatory_direct_debit (Allianz obliga Direct Debit en
                  contratos
                  mensuales)&nbsp;·&nbsp;Payments_per_year&nbsp;·&nbsp;Annual_premium_log1p&nbsp;·&nbsp;conteos
                  cliente/broker&nbsp;·&nbsp;cercanía geográfica cliente-broker.
                </span>
              </div>
          ...
          <section>
            <div className="s-light">
              ...
              {[
                ...
                >
                  <div
                    className="metric-num-med"
                    style={{ color: m.color, fontSize: '2.4rem' }}
                  >
                    {m.val}
                  </div>
                  <div
              ...
              >
                ...
                >
                  <span style={{ fontWeight: 700, color: 'var(--dark)' }}>
                    El modelo aporta valor real.&nbsp;&nbsp;
                  </span>
                  <span className="t-body-light" style={{ fontSize: '.74rem' }}>
                    El baseline acierta 79% solo prediciendo la clase
                    mayoritaria, pero no detecta ni un solo caso de Direct Debit
                    (F1 = 0).
                  </span>
                </div>
              </div>
            ...
            <div className="s-light">
              ...
              >
                ...
                >
                  ...
                  <div className="cm-cell cm-tn">
                    <div className="cm-num" style={{ color: 'var(--dark)' }}>
                      71,394
                    </div>
                    <div className="cm-lbl" style={{ color: 'var(--gray)' }}>
                      Verdaderos negativos
                    </div>
                  </div>
                  <div className="cm-cell cm-fp">
                    <div className="cm-num" style={{ color: 'var(--red)' }}>
                      31
                    </div>
                    <div className="cm-lbl" style={{ color: 'var(--red)' }}>
                      Falsos positivos
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="cm-cell cm-tp">
                    <div className="cm-num" style={{ color: '#16A34A' }}>
                      17,709
                    </div>
                    <div className="cm-lbl" style={{ color: '#16A34A' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    Solo 31 falsos positivos
                  </div>
                  <div className="t-body-light" style={{ fontSize: '.76rem' }}>
                    Casi nunca recomienda contactar a un cliente equivocado →
                    precision del 99.8% y eficiencia de campaña.
                  </div>
                </div>
                <div
                  className="card-w"
                ...
                >
                  ...
                  >
                    1,298 falsos negativos
                  </div>
                  <div className="t-body-light" style={{ fontSize: '.76rem' }}>
                    Algunas oportunidades reales aún no se detectan → recall del
                    93.2%, margen de mejora identificado.
                  </div>
                </div>
                <div
                  className="card-w"
                  style={{ borderLeft: '3px solid var(--dark)' }}
                >
                  <div
                    style={{
                      fontWeight: 700,
                  ...
                  >
                    Foco comercial limpio
                  </div>
                  <div className="t-body-light" style={{ fontSize: '.76rem' }}>
                    La lista de contactos generada es altamente confiable:
                    minimiza el desperdicio de presupuesto de marketing.
                  </div>
                </div>
              </div>
          ...
          <section>
            <div className="s-light">
              ...
              >
                ...
                <img
                  src="/pptx-assets/image-7-1.png"
                  alt="Curva ROC"
                  style={{
                    width: '100%',
                    borderRadius: 8,
                    border: '1px solid rgba(30,39,97,.1)',
                  }}
                />
                <div
                  className="t-body-light"
                  style={{ marginTop: '.5rem', fontSize: '.76rem' }}
                >
                  AUC de 0.98: separa de forma excelente los contratos que usan
                  Direct Debit de los que no.
                </div>
              </div>
              ...
              >
                ...
                <div
                  ...
                  style={{ marginTop: '.5rem', fontSize: '.76rem' }}
                >
                  AP de 0.97: mantiene alta precisión incluso al capturar gran
                  parte de los positivos — clave con datos desbalanceados.
                </div>
              </div>
            ...
            <div className="s-light">
              ...
              >
                ...
                {[
                  ...
                  {
                    label: 'Direct Debit mensual obligatorio',
                    val: 0.1574,
                    color: 'var(--dark)',
                  },
              ...
              >
                <div className="card-w card-w-border-l">
                  ...
                  <div className="t-body-light" style={{ fontSize: '.76rem' }}>
                    La frecuencia mensual concentra el 81% de la importancia.
                    Tiene sentido: Allianz obliga Direct Debit en contratos
                    mensuales, así que el modelo aprende esta regla operativa.
                  </div>
                </div>
                <div
                  className="card-w"
                  style={{ borderLeft: '4px solid #4A7FC1' }}
                >
                  <div
                    style={{
                      fontWeight: 700,
                  ...
                  <div className="t-body-light" style={{ fontSize: '.76rem' }}>
                    Para una versión más exigente, entrenar un modelo sin las
                    variables de pago mensual para descubrir patrones
                    secundarios (segmento, broker, geografía) y enriquecer la
            ...
            <div className="s-light">
              ...
              >
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      display: 'flex',
                      justifyContent: 'space-between',
                      borderBottom: '1px solid rgba(30,39,97,.08)',
                      padding: '.28rem 0',
                      fontSize: '.8rem',
                    }}
                  >
                ...
                >
                  <span style={{ color: 'var(--gray)' }}>
                    Falsos positivos{' '}
                    <strong style={{ color: 'var(--dark)' }}>0</strong>
                  </span>
                  <span style={{ color: 'var(--gray)' }}>
                    Falsos neg.{' '}
                    <strong style={{ color: 'var(--red)' }}>1,323</strong>
                  </span>
                </div>
              </div>
              ...
              >
                ...
                {[
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontWeight: 700,
                        color: v === '0.982' ? 'var(--gold)' : 'var(--dark)',
                      }}
                    >
                      {v}
                    </span>
                ...
                >
                  <span style={{ color: 'var(--gray)' }}>
                    Falsos positivos{' '}
                    <strong style={{ color: 'var(--red)' }}>31</strong>
                  </span>
                  <span style={{ color: 'var(--gray)' }}>
                    Falsos neg.{' '}
                    <strong style={{ color: 'var(--red)' }}>1,298</strong>
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <span className="t-body-light" style={{ fontSize: '.78rem' }}>
                  Ambos modelos son válidos y casi idénticos en exactitud.
                  Random Forest es más conservador (0 falsos positivos); XGBoost
                  detecta más oportunidades reales con mejor recall, ROC-AUC y
                  Average Precision. Como el objetivo es{' '}
                  <strong style={{ color: 'var(--dark)' }}>
                    capturar el mayor número de oportunidades de conversión
                  </strong>
                  , XGBoost es la opción más alineada al negocio.
                </span>
              </div>
          ...
          <section>
            <div className="s-light">
              ...
              <div
                className="card-w card-w-border-l"
                style={{
                  position: 'absolute',
                  left: '4.5%',
                  top: '26%',
              ...
              >
                ...
                {[
                  {
                    label: 'Toda la base de contratos',
                    w: '100%',
                    bg: 'rgba(30,39,97,.12)',
                    color: 'var(--dark)',
                  },
                  {
                    label: 'Sin Direct Debit hoy',
                    w: '80%',
                    bg: 'rgba(30,39,97,.20)',
                    color: 'var(--dark)',
                  },
                  {
                    label: 'Alta probabilidad (modelo)',
                    w: '60%',
                    bg: 'var(--dark)',
                    color: 'var(--white)',
                  },
                  {
                    label: 'Campaña priorizada',
                    w: '40%',
                    bg: 'var(--gold)',
                    color: 'var(--dark)',
                  },
          ...
          <section>
            <div className="s-dark">
                ...
                {[
                  {
                    icon: '🚀',
                    title: 'Activar',
                    body: 'Entregar la lista priorizada a Marketing y Comercial para una campaña piloto enfocada en los candidatos de mayor probabilidad.',
                  },
                  {
                    icon: '📐',
                    title: 'Medir incrementalidad',
                    body: 'Diseñar un grupo de control para cuantificar la conversión real atribuible al modelo y el impacto en el CCC.',
                  },
                  {
                    icon: '🔬',
                    title: 'Robustecer el modelo',
                    body: 'Reentrenar sin las variables de pago mensual para descubrir señales secundarias y reducir la dependencia de una regla operativa.',
                  },
                  {
                    icon: '📈',
                    title: 'Monitorear y escalar',
                    body: 'Vigilar el recall en producción, recalibrar periódicamente y extender el enfoque a otras líneas y mercados Benelux.',
                  },
                ].map((r) => (
                  <div key={r.title} className="rec-box">
                    ...
                    <div className="t-body-dark" style={{ fontSize: '.78rem' }}>
                      {r.body}
                    </div>
                  </div>
                ))}
              ...
              <Footer
                dark
                num={11}
                section="Recomendación · Siguientes pasos"
              />
            </div>
          </section>
            ...
            <div className="s-light">
              ...
              <div className="demo-shell">
                <div className="demo-panel">
                  ...
                  >
                    Ingresa los atributos de un contrato y ejecuta la predicción
                    para obtener la probabilidad estimada de adopción de
                  ...
                  {[
                    ...
                    <div
                      key={label}
                      style={{
                        borderTop: '1px solid rgba(30,39,97,.1)',
                        padding: '.55rem 0',
                      }}
                    >
                      <div
          ...
          <section>
            ...
            >
              ...
              <div style={{ marginBottom: '1.5rem' }}>
                <img
                  src="/pptx-assets/image-12-1.png"
                  alt="Allianz"
                  style={{ height: 52 }}
                />
              </div>
              ...
              >
                Un modelo de grado productivo (98.5% accuracy, ROC-AUC 0.98) que
                transforma la pregunta del consejo en una lista accionable:
                campañas con foco, menos gasto desperdiciado y un ciclo de caja
                más corto.
              </div>
              ...
              >
                Equipo de Data Analytics&nbsp;·&nbsp;Allianz Benelux Data &amp;
                Analytics Office
              </div>
            </div>
          </section>
